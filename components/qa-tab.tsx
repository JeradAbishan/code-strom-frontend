...
const MarkdownComponents = {
  ...
  p: ({ children, ...props }: any) => (
    <p
      className="mb-4 leading-relaxed text-sm text-gray-800 dark:text-gray-200"
      {...props}
    >
      {children}
    </p>
  ...
  h1: ({ children, ...props }: any) => (
    <h1
      className="text-xl font-bold mb-4 mt-6 first:mt-0 text-gray-900 dark:text-gray-100 border-b border-gray-200 dark:border-gray-700 pb-2"
      {...props}
    >
      {children}
    </h1>
  ...
  h2: ({ children, ...props }: any) => (
    <h2
      className="text-lg font-bold mb-3 mt-5 first:mt-0 text-gray-900 dark:text-gray-100"
      {...props}
    >
      {children}
    </h2>
  ...
  h3: ({ children, ...props }: any) => (
    <h3
      className="text-base font-bold mb-2 mt-4 first:mt-0 text-gray-800 dark:text-gray-200"
      {...props}
    >
      {children}
    </h3>
  ...
  h4: ({ children, ...props }: any) => (
    <h4
      className="text-sm font-semibold mb-2 mt-3 first:mt-0 text-gray-800 dark:text-gray-200"
      {...props}
    >
      {children}
    </h4>
  ...
  ul: ({ children, ...props }: any) => (
    <ul
      className="mb-4 ml-6 space-y-2 list-disc marker:text-gray-600 dark:marker:text-gray-400"
      {...props}
    >
      {children}
    </ul>
  ...
  ol: ({ children, ...props }: any) => (
    <ol
      className="mb-4 ml-6 space-y-2 list-decimal marker:text-gray-600 dark:marker:text-gray-400"
      {...props}
    >
      {children}
    </ol>
  ...
  li: ({ children, ...props }: any) => (
    <li
      className="text-sm leading-relaxed text-gray-800 dark:text-gray-200 pl-1"
      {...props}
    >
      {children}
    </li>
  ...
  blockquote: ({ children, ...props }: any) => (
    <blockquote
      className="border-l-4 border-blue-500 bg-blue-50 dark:bg-blue-950/20 pl-4 py-2 mb-4 italic text-gray-700 dark:text-gray-300 rounded-r-md"
      {...props}
    >
      {children}
    </blockquote>
  ...
  code: ({ children, className, ...props }: any) => {
    ...
    return (
      <pre
        className="bg-gray-900 dark:bg-gray-950 text-gray-100 p-4 rounded-lg mb-4 overflow-x-auto border"
        {...props}
      >
...
export function QATab() {
  ...
  // Set chat started state based on messages
  useEffect(() => {
  ...
  const loadSuggestedQuestions = async () => {
    ...
    try {
      const response = await DocumentAPI.getSuggestedQuestions(
        state.currentDocument.id
      );
  ...
  const handleSendMessage = async () => {
    ...
    try {
      ...
      const errorMessage: Message = {
        ...
        type: "ai",
        content:
          "I'm sorry, but I'm having trouble connecting to the analysis service. Please check your connection and try again.",
        timestamp: "Just now",
        confidence: 0,
        isLoading: false,
      };
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2">
          <Card className="bg-card border-border">
            ...
            <CardContent className={isChatStarted ? "relative pb-20" : ""}>
              {/* Messages */}
              <div
                className={`space-y-4 mb-6 overflow-y-auto ${
                  isChatStarted ? "max-h-[70vh] pb-4" : "max-h-[600px]"
                }`}
              >
                ...
                <div className="flex space-x-2">
                  <div className="relative flex-1">
                    ...
                    <Button
                      ...
                      className="absolute right-1 top-1 bottom-1 bg-primary hover:bg-primary/90 h-auto w-10 p-0"
                      disabled={
                        !state.currentDocument || isAsking || !newMessage.trim()
                      }
                    >
                      {isAsking ? (
              ...
              {/* Fixed position chat input when chat is started */}
              {isChatStarted && (
                <div className="absolute bottom-4 left-4 right-4 z-10">
                  <div className="border border-border rounded-lg shadow-xl p-3 backdrop-blur-sm bg-background/95">
                    <div className="relative">
                      <Input
                        ...
                        className="pr-12 border-0 focus-visible:ring-1 focus-visible:ring-ring bg-background"
                        disabled={!state.currentDocument || isAsking}
                      />
                      <Button
                        onClick={handleSendMessage}
                        className="absolute right-1 top-1 bottom-1 bg-primary hover:bg-primary/90 h-auto w-10 p-0 rounded-md"
                        disabled={
                          !state.currentDocument ||
                          isAsking ||
                          !newMessage.trim()
